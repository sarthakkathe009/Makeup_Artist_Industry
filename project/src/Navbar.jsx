...
function Navbar(){
    ...
    return(
        <>
            ...
            <div className={`navbar navbar-expand-lg fixed-top nav nav-underline ${scrolling ? 'bg-dark' : ''}`}>
                <div className="container-fluid">
                    <a href="/" className="navbar-brand text-light fw-bold fs-4">
                        <span><i className='fa fa-modx fs-1'></i></span>Urban Arts
                    </a>
